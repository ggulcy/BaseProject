...
import com.chanhypark.baseproject.databinding.ActivityMainNew2Binding
...
@AndroidEntryPoint
class NewMainActivity2 : AppCompatActivity(){

    lateinit var binding: ActivityMainNew2Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_main_new2)
